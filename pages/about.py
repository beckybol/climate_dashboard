...
layout = dbc.Container([
    dbc.Row([
        ...
        dbc.Col([
            ...
            dbc.Stack(
            [
                dbc.Button([html.I(className="bi bi-filetype-pdf me-2"), "download CV"], href="assets/cv_bolinger_202602.pdf", color="outline-dark", size="md", className="me-1"),
        ...
        dbc.Col([
            ...
            html.Div([
                ...
                dbc.Badge("Grant Writing", color="primary", className="me-2 p-2"),
